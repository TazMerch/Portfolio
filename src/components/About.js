  ...
  return (
    <div id="about">
        ...
        <div className='about__container'>
            <ul>
                <li className="about__item" data-aos="fade-in">I’m a motivated, self taught software developer. </li>
                ...
                <li className="about__item" data-aos="fade-in">Other hobbies include photography and videography.</li>                
            </ul>
        </div>
    </div>
  )
